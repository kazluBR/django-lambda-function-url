...
- Now you can see the pipeline working [aqui](https://github.com/${{ github.repository }}/actions) . When pushing the staging branch, the deploy will update the staging environment and when doing it in the main, the production environment.
